...
for pkg in ["google.genai", "pydantic", "pyautogui", "keyboard", "colorama", "PIL", "pystray", "cv2", "requests", "pygame", "chess"]:
    try:
...
# Win32 modules used by pin/background drag.
for pkg in ["win32gui", "win32con", "win32api", "pywintypes", "pythoncom"]:
    try:
        _hiddenimports += [pkg]
    except Exception:
        pass
